...
## CI
[![Test dotfiles deployments](https://github.com/codequokka/dotfiles/actions/workflows/test.yaml/badge.svg)](https://github.com/codcequokka/dotfiles/actions/workflows/test.yaml)
